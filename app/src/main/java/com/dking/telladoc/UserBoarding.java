...
public class UserBoarding extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editTextName = findViewById(R.id.boardingName);
        editTextAge = findViewById(R.id.boardingNumber);
        spinnerBloodgroup = findViewById(R.id.bloodspinner);
        buttonSubmit = findViewById(R.id.boardinSubmit);
    ...
    private void saveUserData() {
        ...
        try {
            FirestoreUtils.saveEncryptedUserData(userId, userData, getApplicationContext());
        } catch (Exception e) {
            e.printStackTrace();
        }

        Intent mainIntent = new Intent(UserBoarding.this, Interface.class);
